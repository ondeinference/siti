...
submitting a Contribution to the Project (for example, via a pull request), You
accept and agree to the following terms for Your present and future
Contributions.

This Agreement is adapted from the widely used Apache Software Foundation
Individual Contributor License Agreement and is intended to be simple and fair.
...
- **"Contribution"** means any original work of authorship, including any
  ...
  the Project for inclusion in, or documentation of, the Project.
- **"Submit"** means any form of electronic, verbal, or written communication
  sent to the Project, including but not limited to pull requests, issues, and
  comments, excluding communication conspicuously marked "Not a Contribution."
...
- Each of Your Contributions is Your original creation, or You have the rights to
  submit it.
...
- Your Contributions do not, to Your knowledge, violate any third party's
  copyrights, trademarks, patents, or other intellectual property rights.

## 5. Third-party material

If You submit work that is not Your original creation, You will identify it and
its source and any license or restriction You are aware of, and clearly mark it
(for example, "Submitted on behalf of a third party: [name]").

## 6. No warranty

Contributions are provided "as is" without warranty of any kind. You are not
expected to provide support for Your Contributions, except to the extent You
desire to.

---

**How to sign:** the CLA-assistant bot will prompt you on your first pull
request; signing is a one-time action recorded against your GitHub account.
Corporate contributors may contact **support@getsiti.5mb.app** to arrange an
